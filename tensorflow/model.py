...
class Model():
    ...
    def __init__(self, train_input_file, train_target_file,
        ...
        self.model_file = os.path.join(output_dir, 'model.ckpl')
    ...
    def _init_train(self):
        ...
        with self.train_graph.as_default():
            ...
            # output = tf.Print(output, [output], "Seq2Seq out : ")
    ...
    def train(self, epochs, start=0):
        ...
        with self.train_graph.as_default():
            if os.path.isfile(self.model_file + '.meta') and self.restore_model:
